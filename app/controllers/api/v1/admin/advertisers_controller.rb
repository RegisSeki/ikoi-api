      ...
      class AdvertisersController < ApplicationController
        ...
        def create
          ...
          if advertiser.save
            ...
            render json: {status: 'ERROR', message:'Advertiser not saved', data:advertiser.erros},status: :unprocessable_entity
          end
        end
        ...
        def update
          ...
          if advertiser.update_attributes(advertiser_params)
            ...
            render json: {status: 'ERROR', message:'Advertiser not update', data:advertiser.erros},status: :unprocessable_entity
          end
        end
